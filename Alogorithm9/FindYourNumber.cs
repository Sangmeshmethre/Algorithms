    ...
    internal class FindYourNumber
    {
        ...
        public void Find()
        {
            ...
            while (true)
            {
                ...
                {
                    case 1:
                        //Settin lower to middle value if our number is greater, to check in higher half of the range
                        lower = middle;
                        break;
                    case 2:
                        //Settin higher to middle value if our number is less, to check in lower half of the range
                        higher = middle;
                        break;
                    case 3:
